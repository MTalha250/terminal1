...
const Footer = () => {
  return (
    <footer className="bg-secondary text-white px-8 py-10 md:px-16 2xl:px-0">
      <div className="max-w-screen-2xl mx-auto w-full">
        <div className="flex flex-col md:flex-row justify-between gap-8 max-w-6xl 2xl:max-w-7xl">
