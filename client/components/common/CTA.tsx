...
const CTA = () => {
  return (
    <div className="w-full relative h-[50vh]">
      ...
      />
      <div className="absolute top-0 left-0 w-full h-full bg-black/60 flex flex-col items-center justify-center px-8 md:px-16 py-10 gap-6">
        <h1 className="text-white text-5xl tracking-wide max-w-2xl text-center">
