...
const Map = () => {
  return (
    <div className="py-10 md:py-20 px-8 md:px-16 bg-[#E0EAF4] flex flex-col gap-4 max-w-screen-2xl mx-auto 2xl:px-0">
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-5 md:mt-10">
        <div className="w-full md:w-2/5">
          <div className="flex flex-col gap-4 max-w-sm pl-5 md:pl-10 border-l-2 border-secondary">
        ...
        <iframe
          ...
          loading="lazy"
          className="w-full md:w-3/5 h-[50vh] rounded-lg"
        ></iframe>
      </div>
    </div>
  );
